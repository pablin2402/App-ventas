(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var firebaseConfig = _environments_environment__WEBPACK_IMPORTED_MODULE_22__["environment"].firebaseConfig;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddcookieComponent = /** @class */ (function () {
                function AddcookieComponent(dbData) {
                    this.dbData = dbData;
                    this.contactsForm = this.createFormGroup();
                }
                AddcookieComponent.prototype.createFormGroup = function () {
                ...
                AddcookieComponent.prototype.ngOnInit = function () {
                };
                AddcookieComponent.prototype.onResetForm = function () {
                    this.contactsForm.reset();
                };
                //Manda los datos a firecloud, revisando si todos los campos cumples con los requerimientos dados anteriormente.
                AddcookieComponent.prototype.onSaveForm = function () {
                ...
                Object.defineProperty(AddcookieComponent.prototype, "nombre", {
                    get: function () { return this.contactsForm.get('nombre'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "fondo", {
                    get: function () { return this.contactsForm.get('fondo'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "imagen", {
                    get: function () { return this.contactsForm.get('imagen'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "marca", {
                    get: function () { return this.contactsForm.get('marca'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "peso", {
                    get: function () { return this.contactsForm.get('peso'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "oferta", {
                    get: function () { return this.contactsForm.get('oferta'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "portada", {
                    get: function () { return this.contactsForm.get('portada'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "descripcion", {
                    get: function () { return this.contactsForm.get('descripcion'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "descripcioncorta", {
                    get: function () { return this.contactsForm.get('descripcioncorta'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "ingredientes", {
                    get: function () { return this.contactsForm.get('ingredientes'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "Alergenos", {
                    get: function () { return this.contactsForm.get('Alergenos'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddcookieComponent.prototype, "precio", {
                    get: function () { return this.contactsForm.get('precio'); },
                    enumerable: true,
                    configurable: true
                });
                return AddcookieComponent;
            }());
            AddcookieComponent.ctorParameters = function () { return [
                { type: _services_cookie_service__WEBPACK_IMPORTED_MODULE_2__["CookieService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DetailsCookieComponent = /** @class */ (function () {
                function DetailsCookieComponent(dataApi, route) {
                    this.dataApi = dataApi;
                    this.route = route;
                    this.books = {};
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GoogleMapComponent = /** @class */ (function () {
                function GoogleMapComponent(crudService) {
                ...
                GoogleMapComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.crudService.read_Proveedores().subscribe(function (data) {
                        _this.vendedores = data.map(function (e) {
                            _this.crearmarkersv(e.payload.doc.data()['nombre'], e.payload.doc.data()['latitud'], e.payload.doc.data()['longitud']);
                        });
                    });
                    this.crudService.read_Vendedor().subscribe(function (data) {
                        _this.vendedores = data.map(function (e) {
                            _this.crearmarkers(e.payload.doc.data()['nombre'], e.payload.doc.data()['latitud'], e.payload.doc.data()['longitud']);
                        });
                    });
                };
                ...
                GoogleMapComponent.prototype.crearmarkers = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        draggable: true,
                        lat: parseFloat(b),
                ...
                GoogleMapComponent.prototype.crearmarkersv = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        lat: parseFloat(b),
                        lng: parseFloat(c),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                function HeaderComponent(_backendservice, authService, afsAuth) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListcookiesComponent = /** @class */ (function () {
                function ListcookiesComponent(dataApis) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _services_cookie_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/cookie.service */ "./src/app/services/cookie.service.ts");
            var UploadbookComponent = /** @class */ (function () {
                function UploadbookComponent(dataApi) {
                    this.dataApi = dataApi;
                }
                UploadbookComponent.prototype.ngOnInit = function () {
                };
                UploadbookComponent.prototype.onSaveBook = function (bookForm) {
                    // Update
                    this.dataApi.updateBook(bookForm.value);
                };
                return UploadbookComponent;
            }());
            UploadbookComponent.ctorParameters = function () { return [
                { type: _services_cookie_service__WEBPACK_IMPORTED_MODULE_2__["CookieService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListcontactsComponent = /** @class */ (function () {
                function ListcontactsComponent(dataApi) {
                    this.dataApi = dataApi;
                }
                ListcontactsComponent.prototype.ngOnInit = function () {
                    this.getListBooks();
                };
                ListcontactsComponent.prototype.getListBooks = function () {
                    var _this = this;
                    this.dataApi.getAllBooks()
                        .subscribe(function (books) {
                        _this.books = books;
                ...
                ListcontactsComponent.prototype.onPreUpdateBook = function (book) {
                    //this.dataApi.selectedBook=Object.assign({},book);
                    console.log('BOOK', book);
                    this.dataApi.selectedBook = Object.assign({}, book);
                };
            ...
            ListcontactsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CrudService = /** @class */ (function () {
                ...
                CrudService.prototype.create_NewProducto = function (record) {
                    return this.firestore.collection('Productos').add(record);
                };
                CrudService.prototype.read_Proveedores = function () {
                    return this.firestore.collection('distribuidores').snapshotChanges();
                };
                CrudService.prototype.update_Proveedor = function (recordID, record) {
                    this.firestore.doc('Proveedores/' + recordID).update(record);
                };
                CrudService.prototype.read_Vendedor = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ActualizarComponent = /** @class */ (function () {
                function ActualizarComponent(dataApi, crudService, dataAp) {
                    this.dataApi = dataApi;
                    this.crudService = crudService;
                    this.dataAp = dataAp;
                    this.lat = -17.393851495957517;
                ...
                ActualizarComponent.prototype.onSaveBook = function (bookForm) {
                    // Update
                    this.dataApi.updateBook(bookForm.value);
                };
                ActualizarComponent.prototype.mapClicked = function ($event) {
                    this.markers.push({
                        label: this.contador.toString(),
                        lat: $event.coords.lat,
                        lng: $event.coords.lng,
                ...
                ActualizarComponent.prototype.markerDragEnd = function (m, $event) {
                    console.log('dragEnd', m, $event);
                    this.markers.push({
                        label: m.label,
                        lat: $event.coords.lat,
                ...
                ActualizarComponent.prototype.crearmarkers = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        draggable: true,
                        lat: parseFloat(b),
                ...
                ActualizarComponent.prototype.crearmarkersv = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        lat: parseFloat(b),
                        lng: parseFloat(c),
                ...
                ActualizarComponent.prototype.clickedMarker = function (label, index) {
                    console.log("clicked the marker: " + (label || index));
                };
                return ActualizarComponent;
            }());
            ActualizarComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdddisComponent = /** @class */ (function () {
                function AdddisComponent(dbData, crudService, toastrService) {
                    this.dbData = dbData;
                    this.crudService = crudService;
                ...
                AdddisComponent.prototype.createFormGroup = function () {
                    return new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
                ...
                AdddisComponent.prototype.mapClicked = function ($event) {
                    this.markers.push({
                        label: this.contador.toString(),
                        lat: $event.coords.lat,
                        lng: $event.coords.lng,
                ...
                AdddisComponent.prototype.markerDragEnd = function (m, $event) {
                    console.log('dragEnd', m, $event);
                    this.markers.push({
                        label: m.label,
                        lat: $event.coords.lat,
                ...
                AdddisComponent.prototype.crearmarkers = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        draggable: true,
                        lat: parseFloat(b),
                ...
                AdddisComponent.prototype.crearmarkersv = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        lat: parseFloat(b),
                        lng: parseFloat(c),
                ...
                AdddisComponent.prototype.clickedMarker = function (label, index) {
                    console.log("clicked the marker: " + (label || index));
                };
                AdddisComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.crudService.read_Proveedores().subscribe(function (data) {
                        _this.vendedores = data.map(function (e) {
                            _this.crearmarkersv(e.payload.doc.data()['nombre'], e.payload.doc.data()['latitud'], e.payload.doc.data()['longitud']);
                ...
                AdddisComponent.prototype.onResetForm = function () {
                    this.contacForm.reset();
                };
                AdddisComponent.prototype.onSaveForm = function () {
                ...
                Object.defineProperty(AdddisComponent.prototype, "correo", {
                    get: function () { return this.contacForm.get('correo'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AdddisComponent.prototype, "nombre", {
                    get: function () { return this.contacForm.get('nombre'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AdddisComponent.prototype, "pais", {
                    get: function () { return this.contacForm.get('pais'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AdddisComponent.prototype, "longitud", {
                    get: function () { return this.contacForm.get('longitud'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AdddisComponent.prototype, "latitud", {
                    get: function () { return this.contacForm.get('latitud'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AdddisComponent.prototype, "telefono", {
                    get: function () { return this.contacForm.get('telefono'); },
                    enumerable: true,
                    configurable: true
                });
                return AdddisComponent;
            }());
            AdddisComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _services_distribuidor_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/distribuidor.service */ "./src/app/services/distribuidor.service.ts");
            var ListdistribuidoresComponent = /** @class */ (function () {
                function ListdistribuidoresComponent(dataApi) {
                    this.dataApi = dataApi;
                }
                ListdistribuidoresComponent.prototype.ngOnInit = function () {
                    this.getListBooks();
                };
                ListdistribuidoresComponent.prototype.getListBooks = function () {
                    var _this = this;
                    this.dataApi.getAllBooks()
                        .subscribe(function (books) {
                        _this.books = books;
                ...
                ListdistribuidoresComponent.prototype.onDeleteBook = function (idBook) {
                    var confirmacion = confirm('¿Estás seguro que deseas eliminar el producto?');
                    if (confirmacion) {
                        this.dataApi.deleteBook(idBook);
                    }
                };
                ListdistribuidoresComponent.prototype.onPreUpdateBook = function (book) {
                    //this.dataApi.selectedBook=Object.assign({},book);
                    console.log('BOOK', book);
                    this.dataApi.selectedBook = Object.assign({}, book);
                };
                return ListdistribuidoresComponent;
            }());
            ListdistribuidoresComponent.ctorParameters = function () { return [
                { type: _services_distribuidor_service__WEBPACK_IMPORTED_MODULE_2__["DistribuidorService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/firestore/es2015/index.js");
            var AsignarService = /** @class */ (function () {
                function AsignarService(afs) {
                    this.afs = afs;
                    this.selectedBook = {};
                    this.booksCollection = afs.collection('asignarvendedor');
                    this.books = this.booksCollection.valueChanges();
                }
                AsignarService.prototype.deleteBook = function (idBook) {
                    this.bookDoc = this.afs.doc("asignarvendedor/" + idBook);
                    this.bookDoc.delete();
                };
                AsignarService.prototype.saveMessage = function (newContact) {
                    this.booksCollection.add(newContact);
                };
                AsignarService.prototype.addBook = function (book) {
                    this.booksCollection.add(book);
                };
                AsignarService.prototype.updateBook = function (book) {
                    var idBook = book.uid;
                    this.bookDoc = this.afs.doc("asignarvendedor/" + idBook);
                    this.bookDoc.update(book);
                };
                return AsignarService;
            }());
            AsignarService.ctorParameters = function () { return [
                { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactoService = /** @class */ (function () {
                ...
                ContactoService.prototype.getAllBooks = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CookieService = /** @class */ (function () {
                ...
                CookieService.prototype.saveMessage = function (newContact) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/firestore/es2015/index.js");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var DistribuidorService = /** @class */ (function () {
                function DistribuidorService(afs) {
                    this.afs = afs;
                    this.selectedBook = {};
                    this.booksCollection = afs.collection('distribuidores');
                    this.books = this.booksCollection.valueChanges();
                }
                DistribuidorService.prototype.getAllBooks = function () {
                    return this.books = this.booksCollection.snapshotChanges()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (changes) {
                        return changes.map(function (action) {
                            var data = action.payload.doc.data();
                ...
                DistribuidorService.prototype.updateBook = function (book) {
                    var idBook = book.id;
                    this.bookDoc = this.afs.doc("distribuidores/" + idBook);
                    this.bookDoc.update(book);
                };
                DistribuidorService.prototype.deleteBook = function (idBook) {
                    this.bookDoc = this.afs.doc("distribuidores/" + idBook);
                    this.bookDoc.delete();
                };
                DistribuidorService.prototype.saveMessage = function (newContact) {
                    this.booksCollection.add(newContact);
                };
                return DistribuidorService;
            }());
            DistribuidorService.ctorParameters = function () { return [
                { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WorkerService = /** @class */ (function () {
                ...
                WorkerService.prototype.getAllBooks = function () {
                    return this.books = this.booksCollection.snapshotChanges()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (changes) {
                        return changes.map(function (action) {
                            var data = action.payload.doc.data();
                ...
                WorkerService.prototype.saveMessage = function (newContact) {
                    this.booksCollection.add(newContact);
                };
                WorkerService.prototype.deleteBook = function (idBook) {
                    this.bookDoc = this.afs.doc("vendedores/" + idBook);
                    this.bookDoc.delete();
                };
                WorkerService.prototype.updateBook = function (book) {
                    var idBook = book.id;
                    this.bookDoc = this.afs.doc("vendedores/" + idBook);
                    this.bookDoc.update(book);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddworkersComponent = /** @class */ (function () {
                function AddworkersComponent(dbData, crudService) {
                    this.dbData = dbData;
                    this.crudService = crudService;
                    this.lat = -17.393851495957517;
                    this.lng = -66.15186435643;
                ...
                AddworkersComponent.prototype.createFormGroup = function () {
                    return new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
                ...
                AddworkersComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.crudService.read_Proveedores().subscribe(function (data) {
                        _this.vendedores = data.map(function (e) {
                            _this.crearmarkersv(e.payload.doc.data()['nombre'], e.payload.doc.data()['latitud'], e.payload.doc.data()['longitud']);
                ...
                AddworkersComponent.prototype.onResetForm = function () {
                    this.contactsForm.reset();
                };
                AddworkersComponent.prototype.onSaveForm = function () {
                    if (this.contactsForm.valid) {
                        this.dbData.saveMessage(this.contactsForm.value);
                        this.onResetForm();
                        console.log('Valid');
                ...
                //UBICACION ACTUAL
                AddworkersComponent.prototype.getUserLocation = function () {
                    var _this = this;
                    /// locate the user
                ...
                AddworkersComponent.prototype.mapClicked = function ($event) {
                    this.markers.push({
                        label: this.contador.toString(),
                        lat: $event.coords.lat,
                        lng: $event.coords.lng,
                ...
                AddworkersComponent.prototype.markerDragEnd = function (m, $event) {
                    console.log('dragEnd', m, $event);
                    this.markers.push({
                        label: m.label,
                        lat: $event.coords.lat,
                ...
                AddworkersComponent.prototype.crearmarkers = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        draggable: true,
                        lat: parseFloat(b),
                ...
                AddworkersComponent.prototype.crearmarkersv = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        lat: parseFloat(b),
                        lng: parseFloat(c),
                ...
                AddworkersComponent.prototype.clickedMarker = function (label, index) {
                    console.log("clicked the marker: " + (label || index));
                };
                Object.defineProperty(AddworkersComponent.prototype, "nombre", {
                    get: function () { return this.contactsForm.get('nombre'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddworkersComponent.prototype, "correo", {
                    get: function () { return this.contactsForm.get('correo'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddworkersComponent.prototype, "ci", {
                    get: function () { return this.contactsForm.get('ci'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddworkersComponent.prototype, "apellido", {
                    get: function () { return this.contactsForm.get('apellido'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddworkersComponent.prototype, "latitud", {
                    get: function () { return this.contactsForm.get('latitud'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddworkersComponent.prototype, "longitud", {
                    get: function () { return this.contactsForm.get('longitud'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AddworkersComponent.prototype, "telefono", {
                    get: function () { return this.contactsForm.get('telefono'); },
                    enumerable: true,
                    configurable: true
                });
                return AddworkersComponent;
            }());
            AddworkersComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AsignardistComponent = /** @class */ (function () {
                function AsignardistComponent(dbData, dataApi, crudService, db) {
                    this.dbData = dbData;
                    this.dataApi = dataApi;
                    this.crudService = crudService;
                    this.db = db;
                ...
                AsignardistComponent.prototype.createFormGroup = function () {
                    return new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
                ...
                AsignardistComponent.prototype.mapClicked = function ($event) {
                    this.markers.push({
                        label: this.contador.toString(),
                        lat: $event.coords.lat,
                        lng: $event.coords.lng,
                ...
                AsignardistComponent.prototype.markerDragEnd = function (m, $event) {
                    console.log('dragEnd', m, $event);
                    this.markers.push({
                        label: m.label,
                        lat: $event.coords.lat,
                ...
                AsignardistComponent.prototype.crearmarkers = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        draggable: true,
                        lat: parseFloat(b),
                ...
                AsignardistComponent.prototype.crearmarkersv = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        lat: parseFloat(b),
                        lng: parseFloat(c),
                ...
                AsignardistComponent.prototype.clickedMarker = function (label, index) {
                    console.log("clicked the marker: " + (label || index));
                };
                AsignardistComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.crudService.read_Proveedores().subscribe(function (data) {
                        _this.vendedores = data.map(function (e) {
                            _this.crearmarkersv(e.payload.doc.data()['nombre'], e.payload.doc.data()['latitud'], e.payload.doc.data()['longitud']);
                ...
                AsignardistComponent.prototype.onResetForm = function () {
                    this.contacForm.reset();
                };
                AsignardistComponent.prototype.onSaveBook = function (bookForm) {
                ...
                AsignardistComponent.prototype.onSaveForm = function () {
                    if (this.contacForm.valid) {
                ...
                Object.defineProperty(AsignardistComponent.prototype, "uid", {
                    get: function () { return this.contacForm.get('uid'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AsignardistComponent.prototype, "distribuidor", {
                    get: function () { return this.contacForm.get('distribuidor'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AsignardistComponent.prototype, "vendedor", {
                    get: function () { return this.contacForm.get('vendedor'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AsignardistComponent.prototype, "fecha", {
                    get: function () { return this.contacForm.get('fecha'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AsignardistComponent.prototype, "latituddistribuidor", {
                    get: function () { return this.contacForm.get('latituddistribuidor'); },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(AsignardistComponent.prototype, "longituddistribuidor", {
                    get: function () { return this.contacForm.get('longituddistribuidor'); },
                    enumerable: true,
                    configurable: true
                });
                return AsignardistComponent;
            }());
            AsignardistComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListworkersComponent = /** @class */ (function () {
                function ListworkersComponent(dataApi, dialog) {
                    this.dataApi = dataApi;
                    this.dialog = dialog;
                }
                ...
                ListworkersComponent.prototype.getListBooks = function () {
                    var _this = this;
                    this.dataApi.getAllBooks()
                        .subscribe(function (books) {
                        _this.books = books;
                ...
                ListworkersComponent.prototype.onDeleteBook = function (idBook) {
                    var confirmacion = confirm('¿Estás seguro que deseas eliminar el producto?');
                    if (confirmacion) {
                        this.dataApi.deleteBook(idBook);
                    }
                };
                ListworkersComponent.prototype.onPreUpdateBook = function (book) {
                    //this.dataApi.selectedBook=Object.assign({},book);
                    console.log('BOOK', book);
                    this.dataApi.selectedBook = Object.assign({}, book);
                };
            ...
            ListworkersComponent.ctorParameters = function () { return [
                { type: _services_worker_service__WEBPACK_IMPORTED_MODULE_2__["WorkerService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_distribuidor_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/distribuidor.service */ "./src/app/services/distribuidor.service.ts");
            var UploadworkersComponent = /** @class */ (function () {
                function UploadworkersComponent(dbData, dataApi, crudService) {
                    this.dbData = dbData;
                    this.dataApi = dataApi;
                    this.crudService = crudService;
                    //COPIAR MAPAS
                ...
                UploadworkersComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.crudService.read_Proveedores().subscribe(function (data) {
                        _this.vendedores = data.map(function (e) {
                            _this.crearmarkersv(e.payload.doc.data()['nombre'], e.payload.doc.data()['latitud'], e.payload.doc.data()['longitud']);
                ...
                UploadworkersComponent.prototype.mapClicked = function ($event) {
                    this.markers.push({
                        label: this.contador.toString(),
                        lat: $event.coords.lat,
                        lng: $event.coords.lng,
                ...
                UploadworkersComponent.prototype.markerDragEnd = function (m, $event) {
                    console.log('dragEnd', m, $event);
                    this.markers.push({
                        label: m.label,
                        lat: $event.coords.lat,
                ...
                UploadworkersComponent.prototype.crearmarkers = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        draggable: true,
                        lat: parseFloat(b),
                ...
                UploadworkersComponent.prototype.crearmarkersv = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        lat: parseFloat(b),
                        lng: parseFloat(c),
                ...
                UploadworkersComponent.prototype.clickedMarker = function (label, index) {
                    console.log("clicked the marker: " + (label || index));
                };
                //MAPAS FINAL
                UploadworkersComponent.prototype.onSaveBook = function (bookForm) {
                    // Update
                    this.dataApi.updateBook(bookForm.value);
                };
                return UploadworkersComponent;
            }());
            UploadworkersComponent.ctorParameters = function () { return [
                { type: _services_distribuidor_service__WEBPACK_IMPORTED_MODULE_4__["DistribuidorService"] },
                { type: _services_worker_service__WEBPACK_IMPORTED_MODULE_2__["WorkerService"] },
